...
export default function AudienceHero({
  ...
  return (
    ...
    >
      ...
      <section className="relative z-20 mt-16 w-full py-12 md:py-24 lg:py-32 xl:py-36">
        <div className="container max-w-7xl px-4 md:px-6">
          <div className="flex flex-col items-center gap-8 text-center">
            ...
            <div className="flex gap-4">
              <Link
                className="inline-flex w-[200px] items-center justify-center rounded-md bg-primary px-8 py-2 text-sm font-medium text-primary-foreground shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary/80 hover:shadow-xl focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary sm:w-[220px] sm:text-lg"
