  ...
  return (
    <div className="flex flex-col justify-center items-center p-8 pt-24 gap-4">
      ...
      <form className="flex flex-col gap-2 w-full md:w-1/3 lg:w-1/4 bg-card rounded-lg p-4" onSubmit={handleSubmit}>
        ...
        <button className="mt-8 w-fit self-center rounded bg-primary px-4 py-2 text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-primary/80 hover:shadow-xl" type="submit" disabled={isLoading}>Conferma</button>
      </form>
    </div>
  );
}
