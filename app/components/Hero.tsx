...
function Hero() {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-primary dark:bg-secondary">
        ...
        <div className="flex flex-col space-y-4 text-left">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[700px] text-gray-100 md:text-xl dark:text-gray-400">
              A blog dedicated to the latest trends and insights in the world of
              technology.
            </p>
          </div>
