    ...
    <>
      ...
      <main className="">
          ...
          <div className="hidden xl:block">
            <div className="fixed top-0 pt-[4.5rem] pb-4 z-10 w-[100dvw] flex items-start lg:items-center xl:justify-around bg-gradient-to-b from-black/80 via-black/80 via-[5.5rem] to-transparent to-[6.5rem] duration-200 ease-in-out">
            ...
            {services.map((service, index) => (
              ...
              <div key={index} className="snap-start">
                ...
                <div className="h-[100svh] relative">
                  ...
                  />
                  <div className="w-[100svw] p-8 mt-5 absolute bottom-0 bg-gradient-to-t from-white/60 via-white/60 dark:from-black/80 dark:via-black/80 via-85% to-transparent">
